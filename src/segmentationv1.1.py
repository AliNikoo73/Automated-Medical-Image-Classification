...
def segment_lungs_otsu(image):
  """
  Segments the lungs from a chest X-ray image using Otsu's thresholding.
  ...
  thresh, thresholded_img = cv2.threshold(gray, LT, UT, cv2.THRESH_BINARY + cv2.THRESH_OTSU)
...
segmented_lungs, original_with_mask = segment_lungs_otsu(image)

cv2.imwrite(f"/Users/baharmac/Documents/Github/Automated-Medical-Image-Classification/data/masked-segmented/v1.1/segmented_lungs_Threshold {LT}_{UT}.png", segmented_lungs)
cv2.imwrite(f"/Users/baharmac/Documents/Github/Automated-Medical-Image-Classification/data/masked-segmented/v1.1/original_with_mask_Threshold {LT}_{UT}.png", original_with_mask)
